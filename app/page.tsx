        ...
        <div className="container-width section-padding">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-4xl md:text-5xl text-gold mb-2 playfair-heading font-light">
          ...
          <div className="services-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              ...
              >
                ...
                <h3 className="text-xl text-slate-dark mb-3 playfair-heading">{service.title}</h3>
                ...
                >
                  <div className="bg-white rounded-sm p-8 hover:shadow-lg transition-all duration-500 h-full">
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <div className="text-4xl text-gold/30 playfair-heading font-light">{step.number}</div>
                      <div className="text-gold">{step.icon}</div>
                  </div>

                    {/* Title */}
                    <h3 className="text-xl text-slate-dark mb-4 playfair-heading">{step.title}</h3>
